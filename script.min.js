...
//        console.log(data);
        ...
        $.ajax({
            ...
            .done(function(response) {
                window.location = 'https://manage.checkin101.com/login/welcome?name=' + name + '&email=' + email + '&organisation=' + org;
//                alert("You've taken the first step! We'll be in touch to get your team set up"); // show success message
//                var submit = 1;
